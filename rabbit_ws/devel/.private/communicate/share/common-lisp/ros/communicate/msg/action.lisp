...
(cl:defmethod cl:initialize-instance :after ((m <action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communicate-msg:<action> is deprecated: use communicate-msg:action instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communicate-msg:x-val is deprecated.  Use communicate-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communicate-msg:y-val is deprecated.  Use communicate-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader communicate-msg:angle-val is deprecated.  Use communicate-msg:angle instead.")
  (angle m))
